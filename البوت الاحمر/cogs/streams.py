...
class Streams:
    ...
    async def hitbox(self, stream: str):
        """تحقق إذا كان حسابك في هيتبوكس متصلاً بالإنترنت"""
    ...
    async def twitch(self, ctx, stream: str):
        """تحقق إذا كان حسابك في تويتش متصلاً بالإنترنت"""
        stream = escape_mass_mentions(stream)
    ...
    async def mixer(self, stream: str):
        """تحقق إذا كان حسابك في ميكسير متصلاً بالإنترنت"""
        stream = escape_mass_mentions(stream)
    ...
    async def picarto(self, stream: str):
        """تحقق إذا كان حسابك في  بيكارتو  متصلاً بالإنترنت"""
        stream = escape_mass_mentions(stream)
    ...
    async def streamalert(self, ctx):
        """لإضافة / إزالة .. تنبيهات البث من القناة الحالية"""
